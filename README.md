...
```bash
go get github.com/chree188/tiktoken-go
```
## Cache
...
Include if you require this loader: [tiktoken_loader](https://github.com/chree188/tiktoken-go-loader)
...
import (
    "fmt"
    "github.com/chree188/tiktoken-go"
)
